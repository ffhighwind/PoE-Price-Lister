namespace PoE_Price_Lister
{
    ...
    {
        public DivinationValue(DivinationValueEnum value, string toString, float highValue, float lowValue)
        {
            Value = value;
        ...
        public static readonly DivinationValue ChaosLess1 = new DivinationValue(DivinationValueEnum.ChaosLess1, "<1c", 1.5f, 0.7f);
